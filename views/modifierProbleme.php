...
<!-- Mirrored from www.spruko.com/demo/splite/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:33:15 GMT -->
<head>
			...
			<div class="main-wrapper" >
				...
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="afficherRecAdmin.php"><i class="side-menu__icon fa fa-table"></i><span class="side-menu__label">Liste reclamations</span><span class="badge badge-secondary nav-badge1">0</span></a>
							<ul class="slide-menu">
				...
				<div class="app-content">
					<section class="section">
						...
						<div class="page-header">
							<h4 class="page-title">Ajouter une reclamation</h4>
							<ol class="breadcrumb">
...
?>
<form action="editProb.php" method="POST">
<table>
<h3>Modifier Probleme</h3>
...
<!-- Mirrored from www.spruko.com/demo/splite/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:33:20 GMT -->
</html>
