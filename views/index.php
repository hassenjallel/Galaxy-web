...
<body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item "><a class="nav-link " style="color:black;" href="#"  aria-haspopup="true" aria-expanded="false">profil</a></li>
            <li class="nav-item"><a class="nav-link " style="color:black;" href="forum.php"  aria-haspopup="true" aria-expanded="false">forum</a></li>


	          <li class="nav-item ">
            <a class="nav-link dropdown-toggle dropdown active" href="#"  class="nav-link dropdown avtive" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop</a>
...
?>	
  ...
  <select onchange="la(this.value)"  style="width: 370px; height: 40px;font-size: 20px;  border-radius: 50px;background:rgba(230, 230, 230, 0.3);">
