    		...
    		<div class="row justify-content-end">
    			<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
						...
						<form method="POST" action="confirmerLivraison.php">
		<div class="radio">
					  <label><input type="radio" type="float" name="mode1"  > pour vous ?</label>
                      <br>
                      <label><input type="radio" type="float" name="mode2"  > pour quelqu'un d autre?</label>
                      
    </div>
    <input class="btn btn-primary py-3 px-4" type="submit" name="mode" value="Proceed to Checkout">
</form>
    			</div>
