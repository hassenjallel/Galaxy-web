...
$id=$_SESSION["id_produit"];
        ...
        $stock1C=new stockC();
        $listestocks=$stock1C->affichersingle($id);
        $sql="select * from compte where username='".$_SESSION["username"]."'";
...
<html lang="en">
  ...
  <?php } ?>
	<p><a href="cart.php?id=<?php echo $row['id'];?>" class="btn btn-primary py-3 px-5">Add to Cart</a></p>
    			</div>
    		</div>
    	</div>
    </section>
