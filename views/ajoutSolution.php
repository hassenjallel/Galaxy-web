			...
			<div class="main-wrapper" >
				...
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="afficherRecAdmin.php"><i class="side-menu__icon fa fa-table"></i><span class="side-menu__label">Liste reclamations</span><span class="badge badge-secondary nav-badge1"></span></a>
							<ul class="slide-menu">
...
<form method="POST" action="ajoutSolution1.php">
<table>
