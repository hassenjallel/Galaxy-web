				...
				<nav class="navbar navbar-expand-lg main-navbar">
					...
					<ul class="navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
							...
							<span><img src="../assets/img/avatar/hassen.jpg" alt="profile-user" class="rounded-circle w-32 mr-2"></span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								...
								<div class="dropdown-divider"></div><a class="dropdown-item" href="home.html"><i class="mdi  mdi-logout-variant mr-2"></i> <span>Logout</span></a>
							</div>
						</li>
					</ul>
				</nav>
					...
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							<div class="nav-link pl-1 pr-1 leading-none ">
								<img src="../assets/img/avatar/hassen.jpg" alt="user-img" class="avatar-xl rounded-circle mb-1">
           ...
           <!-- taskiret el row !-->            
				...
				<div class="popup-box chat-popup" id="qnimate">
					<div class="popup-head">
						<div class="popup-head-left pull-left"><img src="../assets/img/avatar/hassen.jpg" alt="iamgurdeeposahan" class="mr-2"> Alica Nestle</div>
					...
					<div class="popup-messages">
						<div class="direct-chat-messages">
							...
							<div class="direct-chat-msg">
								...
								<img class="direct-chat-img" src="../assets/img/avatar/hassen.jpg" alt="message user image">
