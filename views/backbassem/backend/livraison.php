...
<head>
	...
	<body>
		...
		<input class="btn btn-info" type="button" value="Météo" onclick="buttonClickGET()"/>
		<p id="zone_meteo"></p>
...
foreach($listelivraisons as $row){
	...
	<input type="hidden" value="<?PHP echo $row['numcommande']; ?>" name="numcommande">
	</td>
	</form>
					<td><a href="modifierlivraison.php?numcommande=<?PHP echo $row['numcommande']; ?>">
<button class="btn btn-warning">Affecter livreur</button>
</a>	</td>
    ...
    ?>
											...
											<form action="trierlivraison.php" methode="POST">
