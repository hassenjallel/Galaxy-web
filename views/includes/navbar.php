	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
							<li class="nav-item active"><a href="dashbord.php" class="nav-link">profil</a></li>
	          ...
	          <li class="nav-item"><a href="afficherProbleme.php" class="nav-link">Contact</a></li>
						<li class="nav-item cta cta-colored"><a href="login.php" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a></li>
